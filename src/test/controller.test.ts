...
describe('Game Controller', () => {
    ...
    it('should construct', () => {
        const controller = new GameController(mock_canvas as any, mock_context as any, ui, theme, new TanksMap("1"), [new Player(0, "P1", Color.black()), new Player(0, "P1", Color.black())], 1);
